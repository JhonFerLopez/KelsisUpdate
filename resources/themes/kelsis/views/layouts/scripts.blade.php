<script type="text/javascript" src="{{ asset(mix('/js/manifest.js', 'themes/kelsis/assets')) }}"></script>

<script type="text/javascript" src="{{ asset(mix('/js/velocity-core.js', 'themes/kelsis/assets')) }}"></script>

<script type="text/javascript" src="{{ asset(mix('/js/components.js', 'themes/kelsis/assets')) }}"></script>
