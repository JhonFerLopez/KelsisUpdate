...
<div class="container category-page-wrapper" style="border: 2px solid red;">
...
<script type="text/x-template" id="image-search-result-component-template">
	<div class="image-search-result" style="border: 2px solid blue;">
...
<script type="text/x-template" id="seach-component-template">
	<section class="search-container row category-container" style="border: 2px solid silver;">
