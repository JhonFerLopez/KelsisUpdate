...
class ProductController extends Controller
{
     ...
     * * @param  \Webkul\Category\Repositories\PreparationRepository  $preparationRepository
    ...
    public function edit($id)
    {
        ...
        $preparations = $this->preparationRepository->getPreparationTree();

        $inventorySources = $this->inventorySourceRepository->findWhere(['status' => 1]);

        return view($this->_config['view'], compact('product', 'categories', 'inventorySources', 'preparations'));
    }
