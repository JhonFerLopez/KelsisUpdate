...
abstract class AbstractType
{
    ...
    public function update(array $data, $id, $attribute = 'id')
    {
        ...
        if (! isset($data['preparations'])) {
            $data['preparations'] = [];
        }

        $product->preparations()->sync($data['preparations']);
    ...
    protected function copyRelationships($product)
    {
        ...
        if (! in_array('preparations', $attributesToSkip)) {
            $product->preparations()->sync($this->product->preparations->pluck('id'));
        }
