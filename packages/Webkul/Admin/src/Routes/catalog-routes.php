...
use Webkul\Preparation\Http\Controllers\PreparationController;
...
Route::group(['middleware' => ['admin'], 'prefix' => config('app.admin_url')], function () {
     ...
     * Preparations routes.
     */
        Route::get('preparations', [PreparationController::class, 'index'])->defaults('_config', [
            'view' => 'admin::catalog.preparations.index',
        ])->name('admin.catalog.preparations.index');

        Route::get('preparations/create', [PreparationController::class, 'create'])->defaults('_config', [
            'view' => 'admin::catalog.preparations.create',
        ])->name('admin.catalog.preparations.create');

        Route::post('preparations/create', [PreparationController::class, 'store'])->defaults('_config', [
            'redirect' => 'admin.catalog.preparations.index',
        ])->name('admin.catalog.preparations.store');

        Route::get('preparations/edit/{id}', [PreparationController::class, 'edit'])->defaults('_config', [
            'view' => 'admin::catalog.preparations.edit',
        ])->name('admin.catalog.preparations.edit');

        Route::put('preparations/edit/{id}', [PreparationController::class, 'update'])->defaults('_config', [
            'redirect' => 'admin.catalog.preparations.index',
        ])->name('admin.catalog.preparations.update');

        Route::get('preparations/products/{id}', [PreparationController::class, 'products'])->name('admin.catalog.preparations.products');

        Route::post('preparations/delete/{id}', [PreparationController::class, 'destroy'])->name('admin.catalog.preparations.delete');

        Route::post('preparations/mass-delete', [PreparationController::class, 'massDestroy'])->defaults('_config', [
            'redirect' => 'admin.catalog.preparations.index',
        ])->name('admin.catalog.preparations.mass_delete');

        Route::post('preparations/mass-update', [PreparationController::class, 'massUpdate'])->defaults('_config', [
            'redirect' => 'admin.catalog.preparations.index',
        ])->name('admin.catalog.preparations.mass_update');

        Route::post('preparations/product/count', [PreparationController::class, 'preparationProductCount'])->name('admin.catalog.preparations.product.count');
