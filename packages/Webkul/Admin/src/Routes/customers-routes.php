...
use Webkul\Admin\Http\Controllers\Customer\TypeDocumentController;
...
Route::group(['middleware' => ['admin'], 'prefix' => config('app.admin_url')], function () {
     ...
     */
    Route::get('typedocument', [TypeDocumentController::class, 'index'])->defaults('_config', [
        'view' => 'admin::customers.typedocument.index',
    ])->name('admin.typedocument.index');

    Route::get('typedocument/create', [TypeDocumentController::class, 'create'])->defaults('_config', [
        'view' => 'admin::customers.typedocument.create',
    ])->name('admin.typedocument.create');

    Route::post('typedocument/create', [TypeDocumentController::class, 'store'])->defaults('_config', [
        'redirect' => 'admin.typedocument.index',
    ])->name('admin.typedocument.store');

    Route::get('typedocument/edit/{id}', [TypeDocumentController::class, 'edit'])->defaults('_config', [
        'view' => 'admin::customers.typedocument.edit',
    ])->name('admin.typedocument.edit');

    Route::put('typedocument/edit/{id}', [TypeDocumentController::class, 'update'])->defaults('_config', [
        'redirect' => 'admin.typedocument.index',
    ])->name('admin.typedocument.update');

    Route::post('typedocument/delete/{id}', [TypeDocumentController::class, 'destroy'])->name('admin.typedocument.delete');
