...
return [
    ...
    */
    [
        ...
        'key'   => 'catalog.preparations',
        'name'  => 'admin::app.acl.preparations',
        'route' => 'admin.catalog.preparations.index',
        'sort'  => 2,
    ], [
        'key'   => 'catalog.preparations.create',
        'name'  => 'admin::app.acl.create',
        'route' => 'admin.catalog.preparations.create',
        'sort'  => 1,
    ], [
        'key'   => 'catalog.preparations.edit',
        'name'  => 'admin::app.acl.edit',
        'route' => 'admin.catalog.preparations.edit',
        'sort'  => 2,
    ], [
        'key'   => 'catalog.preparations.delete',
        'name'  => 'admin::app.acl.delete',
        'route' => 'admin.catalog.preparations.delete',
        'sort'  => 3,
    ], [
        'key'   => 'catalog.preparations.mass-delete',
        'name'  => 'admin::app.acl.mass-delete',
        'route' => 'admin.catalog.preparations.mass_delete',
        'sort'  => 4,
    ], [
        'key'   => 'catalog.preparations.mass-update',
        'name'  => 'admin::app.acl.mass-update',
        'route' => 'admin.catalog.preparations.mass_update',
        'sort'  => 4,
    ], [
    ...
    */
    [
        ...
        'key'   => 'customers.typedocument',
        'name'  => 'admin::app.acl.typedocument',
        'route' => 'admin.typedocument.index',
        'sort'  => 4,
    ], [
        'key'   => 'customers.typedocument.create',
        'name'  => 'admin::app.acl.create',
        'route' => 'admin.typedocument.create',
        'sort'  => 1,
    ], [
        'key'   => 'customers.typedocument.edit',
        'name'  => 'admin::app.acl.edit',
        'route' => 'admin.typedocument.edit',
        'sort'  => 2,
    ], [
        'key'   => 'customers.typedocument.delete',
        'name'  => 'admin::app.acl.delete',
        'route' => 'admin.typedocument.delete',
        'sort'  => 3,
    ], [
